		...
		<Card className="p-8 backdrop-blur bg-surface-raised/50 border-border">
			<div className="space-y-4">
				<div className="flex items-center justify-between">
					<h3 className="text-lg font-semibold text-text">Today's Standup</h3>
					<span className="text-sm text-text-subtle">Jan 16, 2026</span>
				</div>
...
function PreviewField({ label, content }: PreviewFieldProps) {
	return (
		<div className="text-left">
			<label className="text-sm font-medium mb-1 block text-text-soft">
				{label}
			</label>
