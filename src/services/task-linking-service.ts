// src/services/task-linking-service.ts

import { createGitHubAdapter, type GitHubAdapter, type GitHubIssue } from '@/lib/integrations/github/github-adapter';
import type { Task, Standup, ExternalTaskCache, ExternalSource } from '@/types';
